...
public class Ex35_Gamehangman {
    public static void main(String[] args) {
        ...
        do {
            ...
            do {
                ...
                if (!isCorrectGuees(word, asterisks, guess))
                    missed++;
    ...
    public static char[] getWord() {
        String[] words = {"write", "that", "program", "monkey", "monkey", "rooster", "dog", "pig", "rat", "ox", "ox", "tiger", "rabbit", "dragon", "snake", "horse", "sheep"};
    ...
    public static boolean isCorrectGuees(char[] word, char[] blanks, char guess) {
